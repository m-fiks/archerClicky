...
**Archer Clicky Game is a simple "memory" game that allows user to gain points by clicking on the images. The images shuffle after every click, and the user cannot click on the same image more than once. It was made with Create React App and Bootstrap.**
